...
import (
	"context"
	samplecrdv1 "gitweb/pkg/apis/samplecrd/v1"
	versioned "gitweb/pkg/client/clientset/versioned"
	internalinterfaces "gitweb/pkg/client/informers/externalversions/internalinterfaces"
	v1 "gitweb/pkg/client/listers/samplecrd/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SamplecrdV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SamplecrdV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&samplecrdv1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplecrdv1.Foo{}, f.defaultInformer)
}
